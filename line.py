def line() :
	CoA = float(input("Ingresar el coeficiente A:"))
	CoB = float(input("Ingresar el coeficiente B:"))
	CoX1 = float(input("Ingresar el coeficiente X1:"))
	CoX2 = float(input("Ingresar el coeficiente X2:"))
	...
	print("Dados la siguiente ecuacion:")
	print(f"\tP1 ({CoX1}, {Y1})")
	print(f"\tP2 ({CoX2}, {Y2})\n")
